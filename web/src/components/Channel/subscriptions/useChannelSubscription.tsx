...
import {
	...
	NewMessageSubscription$variables,
} from '__generated__/NewMessageSubscription.graphql';
import { MessageNew } from './NewMessageSubscription';

const useChannelSubscription = (
	variables: NewMessageSubscription$variables
) => {
	const newMessageConfig = useMemo<
		GraphQLSubscriptionConfig<NewMessageSubscription>
	>(
		() => ({
