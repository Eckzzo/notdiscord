...
import { fadeIn, fadeOut, fadeStyles, moveIn, moveOut, moveStyles } from './Animation';
...
const Content = React.forwardRef<React.ElementRef<typeof StyledContent>, DialogContentProps>(
  ({ children, ...props }, ref) => (
